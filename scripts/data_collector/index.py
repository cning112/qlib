...
class IndexBase:
    ...
    def save_new_companies(self):
        ...
        Examples
        -------
            $ python collector.py save_new_companies --index_name CSI300 --qlib_dir ~/.qlib/qlib_data/cn_1d
        """
    ...
    def parse_instruments(self):
        ...
        Examples
        -------
            $ python collector.py parse_instruments --index_name CSI300 --qlib_dir ~/.qlib/qlib_data/cn_1d
        """
